...
In the next chapter, we explore a deeper integration, using similar techniques, a more advanced instrument model and data from the HERA-19 commissioning array.