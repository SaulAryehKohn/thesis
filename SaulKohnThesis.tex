...
Detection of redshifted 21\,cm brightness temperature fluctuations from the neutral hydrogen would provide a direct, inherently three-dimensional probe of astrophysics and cosmology during this transformational stage of cosmic history.
...
We show, separately, both the widest and the deepest integrations on polarized power in the EoR window. All results are consistent with negligible leakage, to the noise levels attained. Our deep integration also represents the best limits to date on both polarized and unpolarized power in the EoR window. Polarized redundant calibration is also described and implemented on observations for the first time in this work.
...
%
%
\include{chapters/psa128_pol/psa128_pol}
%
%
%
