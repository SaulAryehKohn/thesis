...
%blah di blah
% PAPER & HERA teams
% Danny, Carina, Matt, Josh K., Paul LP, Jon Ringuette, Zac
% generally awesome and supportive cohort + SAS fellowship
% Friends: Ashley, Christian, Elodie, Julie, Steve K., Irteza, Rachel W., Christina, Alyssa, Rachel
% James (who counts as a friend too)
% Kohns & Goodmans
My siblings: Hannah, Yosef and Ezra are always full of loving support and cutting sarcasm -- neither of which I would want to be without.
% Gabby
...
%
% XXX IMAGES GETTING CUT OFF IN IMAGING SECTION
%
...
%
%  S1E2: 
% - bad JD identification, 
% - xx,yy firstcal (single per epoch), 4pol+minV cal, bl pull, 
...
%
% be upfront about Q in the field about whether this IS possible
% our argument -> Cls
