...
% where to go next
%
% polarization needs to be characterized down to EoR dynamic ranges
...
% global signal needs dedicated experiment -- cite something from Kara
